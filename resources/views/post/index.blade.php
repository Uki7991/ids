...
@section('content')
    ...
    <section id="uslugi" class="container">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 col-md-6 p-3 min-benefit-height" style="background-color: #28ABCA;">
                            ...
                            <p class="small text-light">В клинике работают высококвалифицированные специалисты, имеющие международные
                        ...
                        <div class="col-12 col-md-6 p-3 min-benefit-height" style="background-color: #0698BE;">
                            ...
                            <p class="small text-light">Безопасность: строжайшие регламенты стерилизации инструментов.</p>
                        </div>
                        <div class="col-12 col-md-6 p-3 min-benefit-height" style="background-color: #0083A6;">
                            ...
                            <p class="small text-light">Философия комплексного лечения позволяет добиваться долгосрочных результатов на
                        ...
                        <div class="col-12 col-md-6 p-3 min-benefit-height" style="background-color: #00759A;">
                            ...
                            <p class="small text-light">Качество и безопасность стоматологической помощи на международными уровне.
    ...
    <section id="blog" class="container pb-5">
        ...
        <div class="row justify-content-center mt-5 mb-3">
            <a href="#" class="btn btn-outline-primary">Посмотреть еще новости...</a>
        </div>
    </section>

    <section class="d-none d-md-block" style="background-image: url('img/1.jpg'); background-attachment: fixed;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-4 pl-0">
                    <img class="img-fluid" src="img/DSC_1846.jpg" alt="Card image cap">
                </div>
